...
export default class ConsoleController extends Controller {
    ...
    @tracked headerActionsElement = null;
    ...
    _findHeaderElement(attempt) {
        later(this, () => {
            const el = document.getElementById('view-header-actions');
            if (el) {
                this.headerActionsElement = el;
            } else if (attempt < 5) {
                this._findHeaderElement(attempt + 1);
            }
        }, 300 + attempt * 300);
    }
