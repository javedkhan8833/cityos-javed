...
/**
 * Generated from protobuf message <code>temporal.api.cloud.identity.v1.UserGroup</code>
 */
class UserGroup extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.temporal.api.cloud.identity.v1.UserGroupSpec spec = 3;</code>
     */
    protected $spec = null;
    /**
     ...
     *           The current version of the group specification
     *           The next update operation will have to include this version
     *     @type \Temporal\Api\Cloud\Identity\V1\UserGroupSpec $spec
     *           The group specification
     ...
     *
     * Generated from protobuf field <code>.temporal.api.cloud.identity.v1.UserGroupSpec spec = 3;</code>
     * @return \Temporal\Api\Cloud\Identity\V1\UserGroupSpec|null
     */
     ...
     *
     * Generated from protobuf field <code>.temporal.api.cloud.identity.v1.UserGroupSpec spec = 3;</code>
     * @param \Temporal\Api\Cloud\Identity\V1\UserGroupSpec $var
     * @return $this
     */
    public function setSpec($var)
    {
        GPBUtil::checkMessage($var, \Temporal\Api\Cloud\Identity\V1\UserGroupSpec::class);
        $this->spec = $var;
