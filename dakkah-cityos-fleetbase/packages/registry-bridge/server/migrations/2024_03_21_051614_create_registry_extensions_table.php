...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('registry_extensions', function (Blueprint $table) {
            ...
            $table->string('registry_user_uuid', 191)->nullable();
            $table->string('current_bundle_uuid', 191)->nullable();
            $table->string('next_bundle_uuid', 191)->nullable();
            $table->string('icon_uuid', 191)->nullable();
            $table->string('category_uuid', 191)->nullable();
