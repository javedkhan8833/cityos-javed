...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::table('vehicles', function (Blueprint $table) {
            $table->string('telematic_uuid', 191)->after('company_uuid')->nullable()->constrained('telematics', 'uuid')->nullOnDelete();
            $table->string('warranty_uuid', 191)->after('telematic_uuid')->nullable()->constrained('warranties', 'uuid')->nullOnDelete();
            $table->string('category_uuid', 191)->after('telematic_uuid')->nullable()->constrained('categories', 'uuid')->nullOnDelete();
