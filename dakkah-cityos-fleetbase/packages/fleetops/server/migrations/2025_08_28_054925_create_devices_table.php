...
return new class extends Migration {
    public function up(): void
    {
        ...
        Schema::table('devices', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('devices', 'warranty_uuid')) {
                $table->string('warranty_uuid', 191)->after('uuid')->nullable()->constrained('warranties', 'uuid')->nullOnDelete();
            }

            // telematic_uuid (1:1 to telematics.uuid)
            if (!Schema::hasColumn('devices', 'telematic_uuid')) {
                $table->string('telematic_uuid', 191)->after('uuid')->nullable()->constrained('telematics', 'uuid')->nullOnDelete();
            }
            ...
            if (!Schema::hasColumn('devices', 'attachable_type') && !Schema::hasColumn('devices', 'attachable_uuid')) {
                ...
                $table->string('attachable_uuid', 191)->after('telematic_uuid')->nullable();
    ...
    public function down(): void
    {
        ...
        Schema::table('devices', function (Blueprint $table) {
            if (!Schema::hasColumn('devices', 'vehicle_uuid')) {
                $table->string('vehicle_uuid', 191)->after('uuid')->nullable();
            }
        });
