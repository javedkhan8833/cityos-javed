...
return new class extends Migration {
    public function up(): void
    {
        ...
        DB::statement("UPDATE devices SET last_position = ST_GeomFromText('POINT(0 0)', 4326) WHERE last_position IS NULL");

        // Make column NOT NULL
        DB::statement('ALTER TABLE devices ALTER COLUMN last_position SET NOT NULL');
        ...
        Schema::table('sensors', function (Blueprint $table) {
            ...
            $table->string('telematic_uuid', 191)->nullable()->after('company_uuid')->constrained('telematics', 'uuid')->nullOnDelete();
        ...
        DB::statement("UPDATE sensors SET last_position = ST_GeomFromText('POINT(0 0)', 4326) WHERE last_position IS NULL");
        DB::statement('ALTER TABLE sensors ALTER COLUMN last_position SET NOT NULL');
