...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::table('vehicles', function (Blueprint $table) {
            ...
            \Illuminate\Support\Facades\DB::statement('ALTER TABLE vehicles ALTER COLUMN vin_data TYPE JSON USING vin_data::json');
    ...
    public function down(): void
    {
        ...
        Schema::table('vehicles', function (Blueprint $table) {
            ...
            $table->dropColumn('measurement_system');
            $table->dropColumn('ownership_type');
            \Illuminate\Support\Facades\DB::statement('ALTER TABLE vehicles ALTER COLUMN vin_data TYPE TEXT');
