...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('assets', function (Blueprint $table) {
            ...
            $table->string('operator_uuid', 191)->nullable();
            ...
            $table->string('assigned_to_uuid', 191)->nullable();
            ...
            $table->string('current_place_uuid', 191)->nullable()->constrained('places', 'uuid')->nullOnDelete();
            $table->string('telematic_uuid', 191)->nullable()->constrained('telematics', 'uuid')->nullOnDelete();
